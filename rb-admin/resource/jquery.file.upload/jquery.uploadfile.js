...
(function ($) {
    ...
    $.fn.uploadFile = function (options) {
        ...
        var s = $.extend({
            ...
            dragDropStr: "<span><b>Arrastra los archivos aqui</b></span>",
            abortStr: "Abortar",
            cancelStr: "Cancelar",
            deletelStr: "Borrar",
            doneStr: "Done",
            multiDragErrorStr: "Multiple File Drag &amp; Drop is not allowed.",
            extErrorStr: "no esta permitido. Extensiones de archivo permitido: ",
            sizeErrorStr: "no esta permitido. Tamaño máximo de archivo: ",
            uploadErrorStr: "Subida de archivo no permitida",
            urlimgedit: '',
            target: '_blank',
            albumid: ''
        }, options);
        ...
        function createCutomInputFile(obj, group, s, uploadLabel) {
            ...
            if (s.multiple) {
                ...
                fileInputStr = "<label class='ajax-upload-label' for='" + fileUploadId + "'>" + s.title + "</label> <input class='ajax-upload-inputfilehidden' type='file' id='" + fileUploadId + "' name='" + s.fileName + "' multiple/>";
            }
        ...
        function createProgressDiv(obj, s) {
            ...
            this.linkfile = $("<div class='ajax-file-upload-green'></div>").appendTo(this.statusbar).hide();
