...
class Conector{
	...
	function conectar() {
		...
		mysql_select_db($this->BaseDatos,$con) or die('[!] No se pudo seleccionar la base de datos. <br /> Probablemente la base de datos no ha sido creada ó no lo ha especificado correctamente en el archivo <code>config.php</code> <br>Mysql error:' . mysql_error());
