...
require_once(__ROOT__.'/rb-script/class/rb-articulos.class.php');
$qa = $objArticulo->Consultar("SELECT id, titulo, titulo_enlace FROM articulos ORDER BY id");
?>
	...
	$( "#newAtributo" ).click(function(event) {
		...
		$('#t_atributo tr:last').after('<tr>'+	
			...
			'<td>'+
				...
				<?php
				while($art = mysql_fetch_array($qa)):
