...
<div id="editor-block" class="editor-window">
	<form id="frm-block">
		...
		<div class="editor-body">
			...
			<textarea name="block_content" id="block_content"></textarea>
		</div>
		<div class="editor-footer">
			<button class="btn-primary" id="block-btn-accept">Guardar</button>
	...
	$(function() {
		// Aceptar cambios
	  $('#block-btn-accept').click(function() {
			// Item Block Id
			var blo_id = $("#block_item_id").val();
			event.preventDefault();
			$.ajax({
		  	method: "POST",
		  	url: "<?= G_SERVER ?>/rb-admin/core/pages2/save.block.php",
