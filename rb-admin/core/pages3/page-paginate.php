<?php
$result = $objDataBase->Ejecutar("SELECT * FROM paginas"); // Consulta SQl
$total = $result->num_rows; // numero total de registros
$link_section = G_SERVER."/rb-admin/index.php?pag=pages"; // Link de retorno
$type = "pages"; // valor para listado de combo, de cuantos mostrar por lista
$nums_show = $_COOKIE['page_show_items']; // registro a mostrar almacenado en cookie
