<?php
$result = $objDataBase->Ejecutar("SELECT * FROM comentarios"); // Consulta SQl
$total = $result->num_rows; // numero total de registros
$link_section = G_SERVER."/rb-admin/index.php?pag=com"; // Link de retorno
$type = "com"; // valor para listado de combo, de cuantos mostrar por lista
$nums_show = $_COOKIE['com_show_items']; // registro a mostrar almacenado en cookie
