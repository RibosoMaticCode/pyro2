<?php
$result = $objDataBase->Ejecutar("SELECT * FROM usuarios"); // Consulta SQl
$total = $result->num_rows; // numero total de registros
$link_section = G_SERVER."/rb-admin/index.php?pag=usu"; // Link de retorno
$type = "usu"; // valor para listado de combo, de cuantos mostrar por lista
