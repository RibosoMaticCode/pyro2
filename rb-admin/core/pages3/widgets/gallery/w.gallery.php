...
?>
<li id="<?= $widget_id ?>" class="widget <?= $class_save?>" data-id="<?= $widget_id ?>" data-type="galleries" data-class="<?php if(isset($widget)) echo $widget['widget_class'] ?>"
	...
	<div class="widget-body">
		<div class="box-edit">
			<div class="box-edit-html" id="box-edit<?= $widget_id ?>">
				<p style="text-align:center;max-width:100%"><img src="core/pages3/widgets/gallery/galleries.png" alt="icon" /></p>
			</div>
