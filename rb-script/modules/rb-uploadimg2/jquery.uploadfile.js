...
(function ($) {
    ...
    $.fn.uploadFile = function (options) {
        ...
        var s = $.extend({
            ...
            dragDropStr: "<span><b>Arrastra los archivos aqui</b></span>", //jiustus
            uploadStr:"Seleccionar archivos", // jiustus
            abortStr: "Abortar",
            cancelStr: "<img class='icon' src='"+options.urlplugin+"cancel.png' alt='icon' />", //jiustus
            deletelStr: "Delete",
            doneStr: "Hecho",
            multiDragErrorStr: "Arrastre de archivos multiples no esta permitido..",
            ...
            uploadErrorStr: "Subida no esta permitido.",
            maxFileCountErrorStr: " no esta permitido. La cantidad permitida de archivos a subir es: ",
            downloadStr: "Descargar",
            customErrorKeyStr: "jquery-upload-file-error",
            showQueueDiv: false,
            statusBarWidth: '100%', //jiustus
            dragdropWidth: '100%', //jiustus
            showPreview: false,
            previewHeight: "auto",
            previewWidth: "100%",
            extraHTML:false,
