...
if(isset($_POST)):
	...
	//if($objUsuario->Insertar( array('admin', $usuario_pass, 'Admin', 'Del Sitio', '', '', '', '', $usuario_correo, '', 1, 'h', 0) )):
		...
		// Niveles de usuarios
		$objDataBase->Ejecutar("INSERT INTO usuarios_niveles (id, nombre, nivel_enlace, permisos) VALUE (1, 'Administrador', 'admin', 'Administra y gestiona la configuración de todo el sitio web')");
		$objDataBase->Ejecutar("INSERT INTO usuarios_niveles (id, nombre, nivel_enlace, permisos) VALUE (2, 'Usuario Gestionador', 'user-panel', 'Usuario con acceso para gestionar parte del sitio web')");
		$objDataBase->Ejecutar("INSERT INTO usuarios_niveles (id, nombre, nivel_enlace, permisos) VALUE (3, 'Usuario Final', 'user-front', 'Usuario final, no tiene acceso a gestionar el sitio web')");
