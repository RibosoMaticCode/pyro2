...
if(isset($_GET['action']) && $_GET['action']=='active'):
	...
	if (!array_key_exists($module_name, $array_modules)){
		...
		if(isset($menu)){
			...
			$menu_panel_array = json_decode($objOpcion->obtener_valor(1,'menu_panel'), true);
			...
			$objOpcion->modificar_valor(1,'menu_panel', json_encode($menu_panel_array));
		}
	}
endif;
...
$objOpcion->modificar_valor(1,'modules_load',$array_modules_json);
