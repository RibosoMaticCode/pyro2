...
?>
<li id="<?= $widget_id ?>" class="widget <?= $class_save?>" data-id="<?= $widget_id ?>" data-type="html" data-class="<?php if(isset($widget)) echo $widget['widget_class'] ?>"
	...
	<div class="widget-body">
		<div class="box-edit">
			...
			<div class="box-edit-tool"><a href="#" class="showEditHtml" title="Clic para editar"><span>Editar</span></a></div>
